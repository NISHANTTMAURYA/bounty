...
def profile(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Check if the profile is complete - only check essential fields
            required_fields = [
                'display_name', 'title', 'hourly_rate'
            ]
            ...
            is_complete = all(form.cleaned_data.get(field) for field in required_fields)
